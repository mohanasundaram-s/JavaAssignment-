...
class chats{
    ...
    static ArrayList<messages> messages_List = new ArrayList<messages>();
    ...
    public void setContact_id(contact con) {
        this.Con_ID = con.getContactID();
    }

    public void SetChatsObject(chats Details) {
        chats_List.put(getContact_id(), Details);
    }
...
class messages {
    ...
    public void setMsgObject(messages messagesObj) {
        chats.messages_List.add(messagesObj);
    }
    ...
    public ArrayList<messages> getMsgObject() {
        return chats.messages_List;
    }
...
class status {
    ...
    String text;
    static HashMap<Integer, status> statuu_list = new HashMap<>();
    static ArrayList<status> statusObj = new ArrayList<>();
    ...
    public static setStatusObj(status detailStatus){
        statusObj.add(detailStatus);
    }
...
public class urlResponse extends contact {
    ...
    public static void getContacts() {
        ...
        while (iterator.hasNext()) {
            ...
            System.out.println("contact Id :" + total + "\tname :" + c.getName());
        }
    }

    // get method for particular contacts.
    public static void getParticularContact(int contact_Id) {
        contact c = Contacts_List.get(contact_Id);
        System.out.println("contact Id :" + c.getContactID() + "\tname :" + c.getName());
    }
    ...
    public static void getParticularChat(int cId) {
        Object chat= chats.chats_List.get(cId);
        System.out.println("chat Id :" +chat);
    }

    // post method for particular send messages.
    public static void sendMessages(int conId, String mssg) {
        if(chats.chats_List.containsKey(conId)) {
            ...
            msg.getMsgId();
            msg.setMessage(mssg);
            msg.setComingStatus("outgoing");
            msg.setMsgObject(msg);
            // /chats.chats_List.put(conId,msg);
    ...
    public static void deleteStatus(int status_id){
        ...
        public static void urlRequest(){
            ...
            System.out.println(msg.getMsgObject());
